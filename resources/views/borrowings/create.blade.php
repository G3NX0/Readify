    ...
    >
      ...
      <form action="{{ route("borrowings.store") }}" method="POST" class="space-y-6">
        ...
        <div>
          ...
          <select name="book_id" class="select-dark" required>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              class="w-full rounded-lg border border-white/10 bg-black/40 text-gray-100 px-4 py-2 focus:ring-2 focus:ring-white/20 focus:border-white/20 transition duration-200 backdrop-blur-md"
              required
            />
            @error("borrowed_at")
              <p class="text-sm text-red-400 mt-1">{{ $message }}</p>
        ...
        <p class="text-sm text-gray-400">Note: Denda keterlambatan Rp10.000 per hari.</p>
