      ...
      <header style="padding: 40px 24px 20px; text-align: center; position: relative">
        <div style="max-width: 1200px; margin: 0 auto">
          <div style="margin-bottom: 20px">
            ...
            <h1
              class="text-glow"
              style="font-size: 40px; font-weight: 800; color: #fff; margin: 0 0 8px 0"
            >
              Book Borrowing System
            </h1>
            <p style="font-size: 18px; color: #888; margin: 0">
              Manage book borrowing and returns efficiently
            </p>
            @if (session("status"))
              <div style="margin-top: 12px" class="glass-effect">
                <div style="padding: 10px; border-radius: 8px; color: #d1fae5">
                  {{ session("status") }}
                </div>
              </div>
            @endif
        ...
        >
          ...
          <div class="form-card glow-effect" style="padding: 32px; border-radius: 20px">
            <div style="margin-bottom: 24px">
              <h2 style="font-size: 28px; font-weight: 700; color: #fff; margin: 0 0 8px 0">
                Borrow a Book
              </h2>
              <p style="color: #888; font-size: 16px; margin: 0">
                Fill out the form below to borrow a book
              </p>
            </div>
            <form
            ...
            >
              ...
              <div>
                ...
                <select
                  id="categorySelect"
                  class="select-dark input-field mt-2 w-full rounded px-3 py-3"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Author will fill automatically"
                  readonly
                />
              </div>
              <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label class="block text-sm font-medium" style="color: #fff">
              ...
              <button
                class="submit-button hover-glow rounded px-4 py-3 font-semibold"
                type="submit"
              >
                Borrow Book
              </button>
          ...
          <div>
            <div style="margin-bottom: 24px">
              ...
              <p style="color: #888; font-size: 16px; margin: 0">
                Track all borrowed books and their status
              </p>
            </div>
            ...
            <div class="scrollable-list">
              @forelse ($borrowings as $borrowing)
                <div
                  class="record-card"
                  style="padding: 24px; border-radius: 12px; margin-bottom: 16px"
                >
                  <div
                    class="record-header"
                    style="
                  ...
                  >
                    <div style="flex: 1">
                      ...
                      >
                        ...
                        @php
                          $fine = $borrowing->calculateFine((int) config("borrowing.fine_per_day", 10000));
                        @endphp
                      ...
                      <p
                        style="color: rgba(255, 255, 255, 0.55); font-size: 12px; margin: 2px 0 0 0"
                      >
                        Borrowed at:
                        {{ optional($borrowing->created_at) ?->timezone(config("app.timezone"))->format("Y-m-d H:i") }}
                      </p>
                    ...
                    >
                      <span
                        class="status-badge {{ $borrowing->returned_at ? "status-returned" : "status-borrowed" }}"
                      >
                  ...
                  >
                    <div>
                      ...
                      <p style="color: rgba(255, 255, 255, 0.85); font-size: 14px; margin: 0">
                        {{ optional($borrowing->borrowed_at)->format("Y-m-d") }}
                      </p>
                    </div>
                    <div>
                      <p
                      ...
                      <p style="color: rgba(255, 255, 255, 0.85); font-size: 14px; margin: 0">
                        {{ optional($borrowing->due_date)->format("Y-m-d") }}
                      </p>
                    </div>
                  </div>
                </div>
              @empty
                <div
                  class="glass-effect"
                  style="padding: 40px; border-radius: 16px; text-align: center"
                >
                  ...
                  <p style="color: rgba(255, 255, 255, 0.7); font-size: 16px; margin: 0">
                    No borrowing records yet. Start by borrowing your first book!
                  </p>
                </div>
              @endforelse
            </div>
    ...
    <script>
      ...
      function populateBooks() {
        ...
        categoryBooks[categoryId].forEach((b) => {
          ...
          if (unavailableBookIds.includes(b.id)) {
            opt.disabled = true;
