<nav class="navbar">
  <style>
    ...
    .mobile-overlay { background: rgba(0,0,0,.4); opacity: 0; pointer-events: none; transition: opacity .25s ease; }
    .mobile-overlay.active { opacity: 1; pointer-events: auto; }
    /* Mobile-only navbar background to improve contrast */
    @media (max-width: 768px) {
      .navbar { background: #000000 !important; border-bottom: 1px solid rgba(255,255,255,0.12); }
    }
    /* Ensure mobile menu overlays above page content */
    .navbar { position: relative; z-index: 100; }
    #navOverlay { z-index: 10000; }
    #navMobileMenu { z-index: 10001; }
  </style>
