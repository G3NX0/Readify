<!--
  ...
  Catatan: gaya visual memakai Tailwind CDN + inline style.
  Komentar ditulis campur (santai + formal) agar tetap informatif.
-->
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div style="max-width: 1200px; margin: 0 auto">
          ...
          >
            <div class="feature-card hover-glow" style="padding: 40px; border-radius: 16px">
              ...
              <h3 style="font-size: 24px; font-weight: 600; color: #ffffff; margin: 0 0 16px 0">
                Manajemen Buku Pintar
              </h3>
              <p style="color: #888888; line-height: 1.6; font-size: 16px">
                Kelola dan kategorikan koleksi buku dengan pencarian dan filter yang cepat.
              </p>
            </div>
            <div class="feature-card hover-glow" style="padding: 40px; border-radius: 16px">
              <div
              ...
              <h3 style="font-size: 24px; font-weight: 600; color: #ffffff; margin: 0 0 16px 0">
                Pelacakan Peminjaman Real‑time
              </h3>
              <p style="color: #888888; line-height: 1.6; font-size: 16px">
                Pantau peminjaman, pengembalian, dan status ketersediaan buku secara langsung.
              </p>
            </div>
            <div class="feature-card hover-glow" style="padding: 40px; border-radius: 16px">
              <div
              ...
              <p style="color: #888888; line-height: 1.6; font-size: 16px">
                Dapatkan wawasan pemakaian dan pengambilan keputusan berbasis data.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="about" style="padding: 80px 24px">
        <div style="max-width: 1200px; margin: 0 auto">
          <div
            ...
            class="lg:grid-cols-2 grid-cols-1"
          >
            <div>
              <h2
                style="
              ...
              <p style="color: #888888; line-height: 1.8; font-size: 18px; margin-bottom: 24px">
                Readify membantu Anda mengelola perpustakaan secara modern—dari katalog,
                peminjaman/pengembalian, hingga perhitungan denda—dengan antarmuka yang ringkas.
              </p>
              <p style="color: #888888; line-height: 1.8; font-size: 18px; margin-bottom: 32px">
                Dirancang dengan performa dan kesederhanaan, cocok untuk perpustakaan sekolah,
                komunitas, maupun pribadi.
              </p>
              <button
                class="cta-button hover-glow"
                style="
                  padding: 16px 32px;
                  border-radius: 12px;
                  font-weight: 600;
            ...
            <div
              class="glass-effect"
              style="padding: 40px; border-radius: 20px; text-align: center"
            >
              ...
              <h3 style="font-size: 24px; font-weight: 600; color: #ffffff; margin: 0 0 16px 0">
                Modern Library Solutions
              </h3>
              <p style="color: #888888; line-height: 1.6">
                Built for the future of library management
              </p>
            </div>
          </div>
        </div>
        ...
        <div style="max-width: 1200px; margin: 0 auto">
          ...
          >
            ...
            <div>
              ...
              <p style="color: #888888; line-height: 1.6; font-size: 16px">
                Solusi ringkas untuk manajemen perpustakaan modern
              </p>
            </div>
            <!-- Quick Links -->
            <div>
              <h4 style="font-size: 18px; font-weight: 600; color: #ffffff; margin: 0 0 20px 0">
                Quick Links
              </h4>
            ...
            <div>
              ...
              <div style="display: flex; flex-direction: column; gap: 12px; color: #888888">
                ...
                <div style="display: flex; align-items: center; gap: 8px">
                  ...
                  >
                    <path
                      d="M22 16.92V19.92C22 20.52 21.39 21 20.92 21C9.11 21 1 12.89 1 1.08C1 0.61 1.48 0 2.08 0H5.08C5.68 0 6.08 0.4 6.08 1C6.08 3.25 6.5 5.45 7.34 7.47C7.48 7.76 7.4 8.11 7.14 8.37L5.9 9.61C7.07 12.02 9.98 14.93 12.39 16.1L13.63 14.86C13.89 14.6 14.24 14.52 14.53 14.66C16.55 15.5 18.75 15.92 21 15.92C21.6 15.92 22 16.32 22 16.92Z"
                      stroke="currentColor"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div>
              ...
              <div style="display: flex; gap: 16px">
                ...
                >
                  ...
                  >
                    <path
                      d="M23 3C22.0424 3.67548 20.9821 4.19211 19.86 4.53C19.2577 3.83751 18.4573 3.34669 17.567 3.12393C16.6767 2.90116 15.7395 2.95718 14.8821 3.28445C14.0247 3.61173 13.2884 4.19445 12.773 4.95371C12.2575 5.71297 11.9877 6.61435 12 7.53V8.53C10.2426 8.57557 8.50127 8.18581 6.93101 7.39624C5.36074 6.60667 4.01032 5.43666 3 4C3 4 -1 13 8 17C5.94053 18.398 3.48716 19.099 1 19C10 24 21 19 21 7.5C20.9991 7.22145 20.9723 6.94359 20.92 6.67C21.9406 5.66349 22.6608 4.39271 23 3V3Z"
                      stroke="currentColor"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M12 14C16.42 14 20 15.79 20 18V20H4V18C4 15.79 7.58 14 12 14Z"
                      stroke="currentColor"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
          ...
          >
            <p style="color: #888888; font-size: 14px; margin: 0">
              © 2024 Readify. All rights reserved. | Privacy Policy | Terms of Service
            </p>
          </div>
        </div>
      </footer>
