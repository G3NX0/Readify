...
@section('content')
  ...
  <style>
    ...
    .icon-btn { display:inline-flex; align-items:center; justify-content:center; width:32px; height:32px; border-radius:8px; border:1px solid rgba(255,255,255,0.35); color:#fff; transition: background 0.2s; margin-left:4px; }
    ...
    <div class="filter-bar">
      ...
      <div class="left-group">
        ...
        <a href="{{ route('books.create') }}"
          ...
          <i class="bi bi-plus-lg mr-1"></i> New Book
        </a>
    </div>
  </form>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      const fetchResults = () => {
        ...
        .catch(() => results.innerHTML = `<div class="text-center py-6 text-red-500">Error loading data</div>`);
      };
