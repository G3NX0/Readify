...
<div class="flex justify-center items-start pt-10">
  <div class="w-full max-w-lg bg-black/30 backdrop-blur-2xl rounded-2xl shadow-2xl p-8 border border-white/10">

    <h1 class="text-3xl font-semibold text-gray-100 mb-8 tracking-wide drop-shadow-lg">Create New Category</h1>
